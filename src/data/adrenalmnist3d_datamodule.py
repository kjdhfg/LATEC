...
class AdrenalMNSIT3DDataModule(LightningDataModule):
    def __init__(
        ...
        if not os.path.exists(data_dir + "/AdrenalMNIST3D"):
            print("Downloading AdrenalMNIST3D data...")

            data_url = (
                "https://zenodo.org/record/6496656/files/adrenalmnist3d.npz?download=1"
            )
            save_path = data_dir + "/AdrenalMNIST3D/adrenalmnist3d.npz"

            os.makedirs(data_dir + "/AdrenalMNIST3D/", exist_ok=True)
